    ...
    try {
      ...
      const sampleDestinations: InsertDestination[] = [
        ...
        },
        {
          name: "Kom Ombo",
          slug: "kom-ombo",
          description: "Ancient temple dedicated to Sobek and Haroeris, overlooking the Nile with fascinating crocodile mummies and medical instruments displays.",
          shortDescription: "Ancient dual temple with crocodile mummies and medical artifacts.",
          region: "Upper Egypt",
          imageUrl: "https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 687,
          priceFrom: 45,
        ...
        },
        {
          name: "El Gouna",
          slug: "el-gouna",
          description: "Modern Red Sea resort town with lagoons, golf courses, and vibrant nightlife. Perfect blend of luxury and Egyptian hospitality.",
          shortDescription: "Modern resort town with lagoons and luxury amenities.",
          region: "Red Sea",
          imageUrl: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 1234,
          priceFrom: 120,
          highlights: ["Lagoons", "Golf courses", "Marina", "Nightlife"],
          attractions: ["El Gouna Marina", "Golf Club", "Mangroovy Beach", "Downtown El Gouna"]
        },
        {
          name: "Safaga",
          slug: "safaga",
          description: "Therapeutic black sand beaches and world-class diving sites. Known for healing properties and pristine coral reefs.",
          shortDescription: "Therapeutic black sand beaches and pristine diving sites.",
          region: "Red Sea",
          imageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 892,
          priceFrom: 85,
          highlights: ["Black sand therapy", "Coral reefs", "Diving", "Windsurfing"],
          attractions: ["Safaga Port", "Panorama Reef", "Tobia Arbaa", "Ras Abu Soma"]
        },
        {
          name: "Al Quseir",
          slug: "al-quseir",
          description: "Historic port town with Ottoman architecture and pristine reefs. Gateway to some of the Red Sea's best untouched diving sites.",
          shortDescription: "Historic port with Ottoman architecture and pristine reefs.",
          region: "Red Sea",
          imageUrl: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 543,
          priceFrom: 70,
          highlights: ["Ottoman fort", "Pristine reefs", "Historic architecture", "Quiet beaches"],
          attractions: ["Al Quseir Fort", "Abu Dabbab Beach", "Marsa Shagra", "Old Town"]
        },
        {
          name: "Edfu",
          slug: "edfu",
          description: "Home to the best-preserved temple in Egypt dedicated to Horus. Experience ancient Egyptian architecture in its most complete form.",
          shortDescription: "Best-preserved ancient temple dedicated to Horus.",
          region: "Upper Egypt",
          imageUrl: "https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=800&h=600&auto=format&fit=crop",
          rating: 5,
          reviewCount: 1456,
          priceFrom: 40,
          highlights: ["Temple of Horus", "Ancient hieroglyphs", "Nile cruise stop", "Traditional markets"],
          attractions: ["Temple of Edfu", "Edfu Museum", "Traditional Bazaar", "Nile Corniche"]
        },
        {
          name: "Dahab",
          slug: "dahab",
          description: "Laid-back Bedouin town with world-famous diving at the Blue Hole. Experience authentic Sinai culture and stunning desert landscapes.",
          shortDescription: "Laid-back Bedouin town with world-famous Blue Hole diving.",
          region: "Sinai Peninsula",
          imageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&auto=format&fit=crop",
          rating: 5,
          reviewCount: 2345,
          priceFrom: 60,
          highlights: ["Blue Hole diving", "Bedouin culture", "Desert safaris", "Relaxed atmosphere"],
          attractions: ["Blue Hole", "Lighthouse Reef", "Assalah Square", "Desert excursions"]
        },
        {
          name: "Sharm El Sheikh",
          slug: "sharm-el-sheikh",
          description: "Premier Red Sea resort destination with luxury hotels, incredible diving, and vibrant coral reefs. Gateway to Ras Mohammed National Park.",
          shortDescription: "Premier Red Sea resort with luxury hotels and incredible diving.",
          region: "Sinai Peninsula",
          imageUrl: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&auto=format&fit=crop",
          rating: 5,
          reviewCount: 4567,
          priceFrom: 95,
          highlights: ["Luxury resorts", "Ras Mohammed Park", "Naama Bay", "World-class diving"],
          attractions: ["Ras Mohammed National Park", "Naama Bay", "Shark's Bay", "Old Market"]
        },
        {
          name: "Hurghada",
          slug: "hurghada",
          description: "Vibrant Red Sea resort city with endless beaches, water sports, and marine life. Perfect for families and diving enthusiasts alike.",
          shortDescription: "Vibrant Red Sea resort with endless beaches and water sports.",
          region: "Red Sea",
          imageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 3456,
          priceFrom: 80,
          highlights: ["Beach resorts", "Water sports", "Marine life", "Island excursions"],
          attractions: ["Giftun Island", "Marina Boulevard", "Old Town", "Aquarium"]
        },
        {
          name: "Marsa Alam",
          slug: "marsa-alam",
          description: "Pristine diving destination with dugongs, dolphins, and untouched reefs. The perfect escape for nature lovers and underwater enthusiasts.",
          shortDescription: "Pristine diving destination with dugongs and untouched reefs.",
          region: "Red Sea",
          imageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&auto=format&fit=crop",
          rating: 5,
          reviewCount: 1876,
          priceFrom: 110,
          highlights: ["Dugong encounters", "Pristine reefs", "Dolphin watching", "Eco-lodges"],
          attractions: ["Abu Dabbab Bay", "Samadai Reef", "Wadi Gemal", "Port Ghalib"]
        },
        {
          name: "Al Minya",
          slug: "al-minya",
          description: "Middle Egypt's cultural center with Coptic monasteries, ancient tombs, and traditional crafts. Discover Egypt's Christian heritage and ancient art.",
          shortDescription: "Cultural center with Coptic monasteries and ancient tombs.",
          region: "Middle Egypt",
          imageUrl: "https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 654,
          priceFrom: 55,
          highlights: ["Coptic monasteries", "Ancient tombs", "Traditional crafts", "Nile views"],
          attractions: ["Monastery of St. Samuel", "Beni Hassan Tombs", "Al Minya Museum", "Nile Corniche"]
        },
        {
          name: "Abu Simbel",
          slug: "abu-simbel",
          description: "Ramesses II's magnificent rock-cut temples relocated to save them from flooding. Witness one of humanity's greatest archaeological achievements.",
          shortDescription: "Magnificent rock-cut temples of Ramesses II.",
          region: "Upper Egypt",
          imageUrl: "https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=800&h=600&auto=format&fit=crop",
          rating: 5,
          reviewCount: 2987,
          priceFrom: 180,
          highlights: ["Ramesses II temples", "UNESCO site", "Sun alignment", "Lake Nasser"],
          attractions: ["Great Temple", "Small Temple", "Sound and Light Show", "Lake Nasser Cruise"]
        },
        {
          name: "Beni Suef",
          slug: "beni-suef",
          description: "Gateway to Fayoum Oasis with traditional markets and Nile agriculture. Experience authentic Egyptian rural life and ancient irrigation systems.",
          shortDescription: "Gateway to Fayoum with traditional markets and agriculture.",
          region: "Middle Egypt",
          imageUrl: "https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=800&h=600&auto=format&fit=crop",
          rating: 3,
          reviewCount: 234,
          priceFrom: 35,
          highlights: ["Traditional markets", "Agriculture", "Fayoum access", "Nile views"],
          attractions: ["Central Market", "Nile Corniche", "Agricultural Museum", "Traditional Villages"]
        },
        {
          name: "Giza",
          slug: "giza",
          description: "Home to the Great Pyramid and Sphinx, the last surviving Wonder of the Ancient World. Experience the pinnacle of ancient Egyptian achievement.",
          shortDescription: "Home to the Great Pyramid and Sphinx.",
          region: "Greater Cairo",
          imageUrl: "https://images.unsplash.com/photo-1539650116574-75c0c6d73ab2?w=800&h=600&auto=format&fit=crop",
          rating: 5,
          reviewCount: 8765,
          priceFrom: 75,
          highlights: ["Great Pyramid", "Sphinx", "Solar Boat Museum", "Pyramid complex"],
          attractions: ["Great Pyramid of Khufu", "Great Sphinx", "Pyramid of Khafre", "Solar Boat Museum"]
        },
        {
          name: "Taba",
          slug: "taba",
          description: "Border resort town with stunning mountain and sea views. Gateway to Jordan and Israel with unique multicultural experiences.",
          shortDescription: "Border resort with stunning mountain and sea views.",
          region: "Sinai Peninsula",
          imageUrl: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&auto=format&fit=crop",
          rating: 4,
          reviewCount: 876,
          priceFrom: 90,
          highlights: ["Mountain views", "Border location", "Fjord-like coastline", "Cultural diversity"],
          attractions: ["Taba Heights", "Pharaoh's Island", "Colored Canyon", "Border crossing"]
        }
      ];
